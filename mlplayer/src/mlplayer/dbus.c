 ...
 * Copyright 2009-2011 MLPlayer development team
 *
...
G_DEFINE_TYPE (RemoteObject, mlplayer_rc, G_TYPE_OBJECT)
...
void mlplayer_rc_class_init(RemoteObjectClass * klass)
{
}
...
void mlplayer_rc_init(RemoteObject * object)
{
    GError *error = NULL;
    ...
    dbus_g_object_type_install_info(mlplayer_rc_get_type(), &dbus_glib_mlplayer_rc_object_info);
...
void init_dbus()
{
    ...
    g_type_init();
    g_object_new(mlplayer_rc_get_type(), NULL);
...
{
    *identity = g_strdup_printf("MLPlayer %s", VERSION);
    return TRUE;
}
...
// MLPlayer General Information
bool_t mlplayer_rc_version(RemoteObject * obj, char ** version, GError ** error)
{
    *version = g_strdup(VERSION);
    return TRUE;
}

bool_t mlplayer_rc_quit(RemoteObject * obj, GError * *error)
{
    event_queue("quit", NULL);
    return TRUE;
}

bool_t mlplayer_rc_eject(RemoteObject * obj, GError ** error)
{
    interface_show_filebrowser (TRUE);
    return TRUE;
}

bool_t mlplayer_rc_main_win_visible (RemoteObject * obj,
...
bool_t mlplayer_rc_show_main_win (RemoteObject * obj, bool_t show,
 GError * * error)
{
    interface_show (show);
    return TRUE;
...
bool_t mlplayer_rc_get_tuple_fields(RemoteObject * obj, char *** fields, GError ** error)
{
...
bool_t mlplayer_rc_play (RemoteObject * obj, GError * * error)
{
    drct_play ();
    return TRUE;
}

bool_t mlplayer_rc_pause (RemoteObject * obj, GError * * error)
{
    drct_pause ();
    return TRUE;
}

bool_t mlplayer_rc_stop (RemoteObject * obj, GError * * error)
{
    drct_stop ();
    return TRUE;
}

bool_t mlplayer_rc_playing (RemoteObject * obj, bool_t * is_playing, GError * * error)
{
    * is_playing = drct_get_playing ();
    return TRUE;
}

bool_t mlplayer_rc_paused (RemoteObject * obj, bool_t * is_paused, GError * * error)
{
    * is_paused = drct_get_paused ();
    return TRUE;
}

bool_t mlplayer_rc_stopped (RemoteObject * obj, bool_t * is_stopped, GError * * error)
{
    * is_stopped = ! drct_get_playing ();
    return TRUE;
}

bool_t mlplayer_rc_status (RemoteObject * obj, char * * status, GError * * error)
{
    if (drct_get_playing ())
...
bool_t mlplayer_rc_info (RemoteObject * obj, int * rate, int * freq, int * nch,
 GError * * error)
{
...
bool_t mlplayer_rc_time (RemoteObject * obj, int * time, GError * * error)
{
    * time = drct_get_time ();
    return TRUE;
}

bool_t mlplayer_rc_seek (RemoteObject * obj, unsigned int pos, GError * * error)
{
    drct_seek (pos);
    return TRUE;
}

bool_t mlplayer_rc_volume(RemoteObject * obj, int * vl, int * vr, GError ** error)
{
    drct_get_volume (vl, vr);
    return TRUE;
}

bool_t mlplayer_rc_set_volume(RemoteObject * obj, int vl, int vr, GError ** error)
{
    drct_set_volume (vl, vr);
    return TRUE;
}

bool_t mlplayer_rc_balance(RemoteObject * obj, int * balance, GError ** error)
{
...
bool_t mlplayer_rc_position (RemoteObject * obj, int * pos, GError * * error)
{
    * pos = playlist_get_position (playlist_get_active ());
    return TRUE;
}

bool_t mlplayer_rc_advance(RemoteObject * obj, GError * *error)
{
    drct_pl_next ();
    return TRUE;
}

bool_t mlplayer_rc_reverse (RemoteObject * obj, GError * * error)
{
    drct_pl_prev ();
    return TRUE;
}

bool_t mlplayer_rc_length (RemoteObject * obj, int * length, GError * * error)
{
    * length = playlist_entry_count (playlist_get_active ());
    return TRUE;
}

bool_t mlplayer_rc_song_title (RemoteObject * obj, unsigned int pos, char * *
 title, GError * * error)
{
...
bool_t mlplayer_rc_song_filename (RemoteObject * obj, unsigned int pos,
...
bool_t mlplayer_rc_song_length(RemoteObject * obj, unsigned int pos, int * length, GError * *error)
{
    mlplayer_rc_song_frames(obj, pos, length, error);
    *length /= 1000;
    return TRUE;
}

bool_t mlplayer_rc_song_frames (RemoteObject * obj, unsigned int pos, int *
 length, GError * * error)
{
...
bool_t mlplayer_rc_song_tuple (RemoteObject * obj, unsigned int pos, char *
...
bool_t mlplayer_rc_jump (RemoteObject * obj, unsigned int pos, GError * * error)
{
    playlist_set_position (playlist_get_active (), pos);
    return TRUE;
}

bool_t mlplayer_rc_add(RemoteObject * obj, char * file, GError * *error)
{
    return mlplayer_rc_playlist_ins_url_string(obj, file, -1, error);
}

bool_t mlplayer_rc_add_url(RemoteObject * obj, char * file, GError * *error)
{
    return mlplayer_rc_playlist_ins_url_string(obj, file, -1, error);
}
...
bool_t mlplayer_rc_add_list (RemoteObject * obj, char * * filenames,
 GError * * error)
{
...
bool_t mlplayer_rc_open_list (RemoteObject * obj, char * * filenames,
 GError * * error)
{
...
bool_t mlplayer_rc_open_list_to_temp (RemoteObject * obj, char * *
...
bool_t mlplayer_rc_delete (RemoteObject * obj, unsigned int pos, GError * * error)
{
    playlist_entry_delete (playlist_get_active (), pos, 1);
    return TRUE;
}

bool_t mlplayer_rc_clear (RemoteObject * obj, GError * * error)
{
    int playlist = playlist_get_active ();
...
bool_t mlplayer_rc_auto_advance(RemoteObject * obj, bool_t * is_advance, GError ** error)
{
    * is_advance = ! get_bool (NULL, "no_playlist_advance");
    return TRUE;
}

bool_t mlplayer_rc_toggle_auto_advance(RemoteObject * obj, GError ** error)
{
    set_bool (NULL, "no_playlist_advance", ! get_bool (NULL, "no_playlist_advance"));
    return TRUE;
}

bool_t mlplayer_rc_repeat(RemoteObject * obj, bool_t * is_repeating, GError ** error)
{
    *is_repeating = get_bool (NULL, "repeat");
    return TRUE;
}

bool_t mlplayer_rc_toggle_repeat (RemoteObject * obj, GError * * error)
{
    set_bool (NULL, "repeat", ! get_bool (NULL, "repeat"));
    return TRUE;
}

bool_t mlplayer_rc_shuffle(RemoteObject * obj, bool_t * is_shuffling, GError ** error)
{
    *is_shuffling = get_bool (NULL, "shuffle");
    return TRUE;
}

bool_t mlplayer_rc_toggle_shuffle (RemoteObject * obj, GError * * error)
{
    set_bool (NULL, "shuffle", ! get_bool (NULL, "shuffle"));
    return TRUE;
}

bool_t mlplayer_rc_stop_after (RemoteObject * obj, bool_t * is_stopping, GError * * error)
{
    * is_stopping = get_bool (NULL, "stop_after_current_song");
    return TRUE;
}

bool_t mlplayer_rc_toggle_stop_after (RemoteObject * obj, GError * * error)
{
...
/* New on Oct 5 */
bool_t mlplayer_rc_show_prefs_box(RemoteObject * obj, bool_t show, GError ** error)
{
    event_queue("prefswin show", GINT_TO_POINTER(show));
    return TRUE;
}

bool_t mlplayer_rc_show_about_box(RemoteObject * obj, bool_t show, GError ** error)
{
    event_queue("aboutwin show", GINT_TO_POINTER(show));
    return TRUE;
}

bool_t mlplayer_rc_show_jtf_box(RemoteObject * obj, bool_t show, GError ** error)
{
    if (show)
...
bool_t mlplayer_rc_show_filebrowser(RemoteObject * obj, bool_t show, GError ** error)
{
    if (show)
...
bool_t mlplayer_rc_play_pause (RemoteObject * obj, GError * * error)
{
    if (drct_get_playing ())
        drct_pause ();
    else
...
bool_t mlplayer_rc_get_info (RemoteObject * obj, int * rate, int * freq,
...
bool_t mlplayer_rc_toggle_aot(RemoteObject * obj, bool_t ontop, GError ** error)
{
    hook_call("mainwin set always on top", &ontop);
    return TRUE;
}

bool_t mlplayer_rc_playqueue_add (RemoteObject * obj, int pos, GError * * error)
{
    playlist_queue_insert (playlist_get_active (), -1, pos);
    return TRUE;
}

bool_t mlplayer_rc_playqueue_remove (RemoteObject * obj, int pos, GError * * error)
{
    int playlist = playlist_get_active ();
...
bool_t mlplayer_rc_playqueue_clear (RemoteObject * obj, GError * * error)
{
    int playlist = playlist_get_active ();
...
bool_t mlplayer_rc_get_playqueue_length (RemoteObject * obj, int * length,
 GError * * error)
{
...
bool_t mlplayer_rc_queue_get_list_pos (RemoteObject * obj, int qpos, int * pos,
 GError * * error)
{
...
bool_t mlplayer_rc_queue_get_queue_pos (RemoteObject * obj, int pos, int *
 qpos, GError * * error)
{
...
bool_t mlplayer_rc_playqueue_is_queued (RemoteObject * obj, int pos, bool_t *
...
bool_t mlplayer_rc_playlist_ins_url_string (RemoteObject * obj, char * url, int
 pos, GError * * error)
{
...
bool_t mlplayer_rc_playlist_add(RemoteObject * obj, void *list, GError * *error)
{
    return mlplayer_rc_playlist_ins_url_string(obj, list, -1, error);
}

bool_t mlplayer_rc_playlist_enqueue_to_temp (RemoteObject * obj, char * url,
 GError * * error)
{
...
bool_t mlplayer_rc_get_eq(RemoteObject * obj, double * preamp, GArray ** bands, GError ** error)
{
...
bool_t mlplayer_rc_get_eq_preamp(RemoteObject * obj, double * preamp, GError ** error)
{
    * preamp = get_double (NULL, "equalizer_preamp");
    return TRUE;
}

bool_t mlplayer_rc_get_eq_band(RemoteObject * obj, int band, double * value, GError ** error)
{
    * value = eq_get_band (band);
    return TRUE;
}

bool_t mlplayer_rc_set_eq(RemoteObject * obj, double preamp, GArray * bands, GError ** error)
{
...
bool_t mlplayer_rc_set_eq_preamp(RemoteObject * obj, double preamp, GError ** error)
{
    set_double (NULL, "equalizer_preamp", preamp);
    return TRUE;
}

bool_t mlplayer_rc_set_eq_band(RemoteObject * obj, int band, double value, GError ** error)
{
    eq_set_band (band, value);
    return TRUE;
}

bool_t mlplayer_rc_equalizer_activate(RemoteObject * obj, bool_t active, GError ** error)
{
    set_bool (NULL, "equalizer_active", active);
    return TRUE;
}

bool_t mlplayer_rc_get_active_playlist_name (RemoteObject * obj, char * *
 title, GError * * error)
{
