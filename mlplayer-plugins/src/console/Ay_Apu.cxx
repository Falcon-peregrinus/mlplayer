...
unsigned const inmlpible_freq = 16384;
...
void Ay_Apu::run_until( blip_time_t final_end_time )
{
	...
	for ( int index = 0; index < osc_count; index++ )
	{
		...
		// period
		int half_vol = 0;
		blip_time_t inmlpible_period = (blargg_ulong) (osc_output->clock_rate() +
				inmlpible_freq) / (inmlpible_freq * 2);
		if ( osc->period <= inmlpible_period && !(osc_mode & tone_off) )
		{
