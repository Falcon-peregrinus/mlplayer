...
static GtkActionEntry action_entries_playlist[] = {
    ...
    { "playlist delete", GTK_STOCK_DELETE , N_("Delete Playlist"), "<Shift>D",
      N_("Delete Playlist"), G_CALLBACK(action_playlist_delete) },
        ...
        {"playlist load", GTK_STOCK_OPEN, N_("Import Playlist"), "O",
          ...
          mlpgui_import_playlist},

        {"playlist save", GTK_STOCK_SAVE, N_("Export Playlist"), "<Shift>S",
          N_("Saves the selected playlist."), (GCallback) mlpgui_export_playlist},
 ...
 {"playlist manager", AUD_STOCK_PLAYLIST, N_("Playlist Manager"), "P", NULL, (GCallback) mlpgui_playlist_manager},
 {"queue manager", AUD_STOCK_QUEUETOGGLE, N_("Queue Manager"), "<Ctrl>U", NULL, (GCallback) mlpgui_queue_manager_show}};
...
static GtkActionEntry action_entries_others[] = {
    ...
    { "current track info", GTK_STOCK_INFO , N_("View Track Details"), "I",
      N_("View track details"), G_CALLBACK(mlpgui_infowin_show_current) },
    ...
    { "about mlplayer", GTK_STOCK_DIALOG_INFO , N_("About MLPlayer"), NULL,
      N_("About MLPlayer"), G_CALLBACK(mlpgui_show_about_window) },
    ...
    { "preferences", GTK_STOCK_PREFERENCES , N_("Preferences"), "<Ctrl>P",
      N_("Open preferences window"), G_CALLBACK(mlp_show_prefs_window) },

    { "quit", GTK_STOCK_QUIT , N_("_Quit"), NULL,
      N_("Quit MLPlayer"), G_CALLBACK(mlp_drct_quit) },
    ...
    { "jump to file", GTK_STOCK_JUMP_TO , N_("Jump to File"), "J",
      N_("Jump to File"), G_CALLBACK(mlpgui_jump_to_track) },

    { "jump to time", GTK_STOCK_JUMP_TO , N_("Jump to Time"), "<Ctrl>J",
      N_("Jump to Time"), (GCallback) mlpgui_jump_to_time},
...
{
  const gchar * data = mlp_get_path (AUD_PATH_DATA_DIR);
  gchar * path;
  GError *gerr = NULL;
...
static GtkWidget * create_menu (gint id)
{
    ...
    if (menus[id] == NULL)
    {
        ...
        if (templates[id].plug_name != NULL)
        {
            ...
            GtkWidget * sub = mlp_get_plugin_menu (templates[id].plug_id);
