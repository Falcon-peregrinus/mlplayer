...
{
	mlp_config_set_defaults (MODPLUG_CFGID, modplug_defaults);

	mModProps.mSurround = mlp_get_bool (MODPLUG_CFGID, "Surround");
	mModProps.mOversamp = mlp_get_bool (MODPLUG_CFGID, "Oversampling");
	mModProps.mMegabass = mlp_get_bool (MODPLUG_CFGID, "Megabass");
	mModProps.mNoiseReduction = mlp_get_bool (MODPLUG_CFGID, "NoiseReduction");
	mModProps.mVolumeRamp = mlp_get_bool (MODPLUG_CFGID, "VolumeRamp");
	mModProps.mReverb = mlp_get_bool (MODPLUG_CFGID, "Reverb");
	mModProps.mFastinfo = mlp_get_bool (MODPLUG_CFGID, "FastInfo");
	mModProps.mUseFilename = mlp_get_bool (MODPLUG_CFGID, "UseFileName");
	mModProps.mGrabAmigaMOD = mlp_get_bool (MODPLUG_CFGID, "GrabAmigaMOD");
	mModProps.mPreamp = mlp_get_bool (MODPLUG_CFGID, "PreAmp");
	mModProps.mPreampLevel = mlp_get_double (MODPLUG_CFGID, "PreAmpLevel");
	mModProps.mChannels = mlp_get_int (MODPLUG_CFGID, "Channels");
	mModProps.mBits = mlp_get_int (MODPLUG_CFGID, "Bits");
	mModProps.mFrequency = mlp_get_int (MODPLUG_CFGID, "Frequency");
	mModProps.mResamplingMode = mlp_get_int (MODPLUG_CFGID, "ResamplineMode");
	mModProps.mReverbDepth = mlp_get_int (MODPLUG_CFGID, "ReverbDepth");
	mModProps.mReverbDelay = mlp_get_int (MODPLUG_CFGID, "ReverbDelay");
	mModProps.mBassAmount = mlp_get_int (MODPLUG_CFGID, "BassAmount");
	mModProps.mBassRange = mlp_get_int (MODPLUG_CFGID, "BassRange");
	mModProps.mSurroundDepth = mlp_get_int (MODPLUG_CFGID, "SurroundDepth");
	mModProps.mSurroundDelay = mlp_get_int (MODPLUG_CFGID, "SurroundDelay");
	mModProps.mLoopCount = mlp_get_int (MODPLUG_CFGID, "LoopCount");
}
...
void ModplugXMMS::SetModProps(const Settings& aModProps)
{
	...
	mlp_set_bool (MODPLUG_CFGID, "Surround", mModProps.mSurround);
	mlp_set_bool (MODPLUG_CFGID, "Oversampling", mModProps.mOversamp);
	mlp_set_bool (MODPLUG_CFGID, "Megabass", mModProps.mMegabass);
	mlp_set_bool (MODPLUG_CFGID, "NoiseReduction", mModProps.mNoiseReduction);
	mlp_set_bool (MODPLUG_CFGID, "VolumeRamp", mModProps.mVolumeRamp);
	mlp_set_bool (MODPLUG_CFGID, "Reverb", mModProps.mReverb);
	mlp_set_bool (MODPLUG_CFGID, "FastInfo", mModProps.mFastinfo);
	mlp_set_bool (MODPLUG_CFGID, "UseFileName", mModProps.mUseFilename);
	mlp_set_bool (MODPLUG_CFGID, "GrabAmigaMOD", mModProps.mGrabAmigaMOD);
	mlp_set_bool (MODPLUG_CFGID, "PreAmp", mModProps.mPreamp);
	mlp_set_double (MODPLUG_CFGID, "PreAmpLevel", mModProps.mPreampLevel);
	mlp_set_int (MODPLUG_CFGID, "Channels", mModProps.mChannels);
	mlp_set_int (MODPLUG_CFGID, "Bits", mModProps.mBits);
	mlp_set_int (MODPLUG_CFGID, "Frequency", mModProps.mFrequency);
	mlp_set_int (MODPLUG_CFGID, "ResamplineMode", mModProps.mResamplingMode);
	mlp_set_int (MODPLUG_CFGID, "ReverbDepth", mModProps.mReverbDepth);
	mlp_set_int (MODPLUG_CFGID, "ReverbDelay", mModProps.mReverbDelay);
	mlp_set_int (MODPLUG_CFGID, "BassAmount", mModProps.mBassAmount);
	mlp_set_int (MODPLUG_CFGID, "BassRange", mModProps.mBassRange);
	mlp_set_int (MODPLUG_CFGID, "SurroundDepth", mModProps.mSurroundDepth);
	mlp_set_int (MODPLUG_CFGID, "SurroundDelay", mModProps.mSurroundDelay);
	mlp_set_int (MODPLUG_CFGID, "LoopCount", mModProps.mLoopCount);
}
