...
configure_win_ok_cb(GtkWidget * w, gpointer data)
{
    ...
    /* Save configuration */
    mlp_set_int ("OSS", "audio_device", oss_cfg.audio_device);
    mlp_set_int ("OSS", "mixer_device", oss_cfg.mixer_device);
    mlp_set_int ("OSS", "prebuffer", oss_cfg.prebuffer);
    mlp_set_bool ("OSS", "use_master", oss_cfg.use_master);
    mlp_set_bool ("OSS", "use_alt_audio_device", oss_cfg.use_alt_audio_device);
    mlp_set_string ("OSS", "alt_audio_device", oss_cfg.alt_audio_device);
    mlp_set_bool ("OSS", "use_alt_mixer_device", oss_cfg.use_alt_mixer_device);
    mlp_set_string ("OSS", "alt_mixer_device", oss_cfg.alt_mixer_device);
}
