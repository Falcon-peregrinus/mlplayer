/* Extra Stereo Plugin for MLPlayer
...
static gboolean init (void)
{
	mlp_config_set_defaults ("extra_stereo", stereo_defaults);
	value = mlp_get_double ("extra_stereo", "intensity");
...
static void conf_ok_cb (GtkButton * button, GtkAdjustment * adj)
{
	...
	mlp_set_double ("extra_stereo", "intensity", value);
