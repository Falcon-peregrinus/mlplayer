...
static void vorbis_init(write_output_callback write_output_func)
{
    mlp_config_set_defaults ("filewriter_vorbis", vorbis_defaults);

    v_base_quality = mlp_get_double ("filewriter_vorbis", "base_quality");
...
{
    mlp_set_double ("filewrite_vorbis", "base_quality", v_base_quality);
