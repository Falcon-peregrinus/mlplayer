 ...
 *  (C) copyright 2006-2007 porting to mlplayer by Yoshiki Yazawa <yaz@cc.rim.or.jp>
 *
...
static void mp3_init(write_output_callback write_output_func)
{
    mlp_config_set_defaults ("filewriter_mp3", mp3_defaults);

    vbr_on = mlp_get_int ("filewriter_mp3", "vbr_on");
    vbr_type = mlp_get_int ("filewriter_mp3", "vbr_type");
    vbr_min_val = mlp_get_int ("filewriter_mp3", "vbr_min_val");
    vbr_max_val = mlp_get_int ("filewriter_mp3", "vbr_max_val");
    enforce_min_val = mlp_get_int ("filewriter_mp3", "enforce_min_val");
    vbr_quality_val = mlp_get_int ("filewriter_mp3", "vbr_quality_val");
    abr_val = mlp_get_int ("filewriter_mp3", "abr_val");
    toggle_xing_val = mlp_get_int ("filewriter_mp3", "toggle_xing_val");
    mark_original_val = mlp_get_int ("filewriter_mp3", "mark_original_val");
    mark_copyright_val = mlp_get_int ("filewriter_mp3", "mark_copyright_val");
    force_v2_val = mlp_get_int ("filewriter_mp3", "force_v2_val");
    only_v1_val = mlp_get_int ("filewriter_mp3", "only_v1_val");
    only_v2_val = mlp_get_int ("filewriter_mp3", "only_v2_val");
    algo_quality_val = mlp_get_int ("filewriter_mp3", "algo_quality_val");
    out_samplerate_val = mlp_get_int ("filewriter_mp3", "out_samplerate_val");
    bitrate_val = mlp_get_int ("filewriter_mp3", "bitrate_val");
    compression_val = mlp_get_double ("filewriter_mp3", "compression_val");
    enc_toggle_val = mlp_get_int ("filewriter_mp3", "enc_toggle_val");
    audio_mode_val = mlp_get_int ("filewriter_mp3", "audio_mode_val");
    enforce_iso_val = mlp_get_int ("filewriter_mp3", "enforce_iso_val");
    error_protect_val = mlp_get_int ("filewriter_mp3", "error_protect_val");
...
static void configure_ok_cb(gpointer data)
{
    ...
    mlp_set_int ("filewriter_mp3", "vbr_on", vbr_on);
    mlp_set_int ("filewriter_mp3", "vbr_type", vbr_type);
    mlp_set_int ("filewriter_mp3", "vbr_min_val", vbr_min_val);
    mlp_set_int ("filewriter_mp3", "vbr_max_val", vbr_max_val);
    mlp_set_int ("filewriter_mp3", "enforce_min_val", enforce_min_val);
    mlp_set_int ("filewriter_mp3", "vbr_quality_val", vbr_quality_val);
    mlp_set_int ("filewriter_mp3", "abr_val", abr_val);
    mlp_set_int ("filewriter_mp3", "toggle_xing_val", toggle_xing_val);
    mlp_set_int ("filewriter_mp3", "mark_original_val", mark_original_val);
    mlp_set_int ("filewriter_mp3", "mark_copyright_val", mark_copyright_val);
    mlp_set_int ("filewriter_mp3", "force_v2_val", force_v2_val);
    mlp_set_int ("filewriter_mp3", "only_v1_val", only_v1_val);
    mlp_set_int ("filewriter_mp3", "only_v2_val", only_v2_val);
    mlp_set_int ("filewriter_mp3", "algo_quality_val", algo_quality_val);
    mlp_set_int ("filewriter_mp3", "out_samplerate_val", out_samplerate_val);
    mlp_set_int ("filewriter_mp3", "bitrate_val", bitrate_val);
    mlp_set_double ("filewriter_mp3", "compression_val", compression_val);
    mlp_set_int ("filewriter_mp3", "enc_toggle_val", enc_toggle_val);
    mlp_set_int ("filewriter_mp3", "audio_mode_val", audio_mode_val);
    mlp_set_int ("filewriter_mp3", "enforce_iso_val", enforce_iso_val);
    mlp_set_int ("filewriter_mp3", "error_protect_val", error_protect_val);
