...
{
  mlp_config_set_defaults ("aosd", aosd_defaults);
  ...
  /* position */
  cfg->osd->position.placement = mlp_get_int ("aosd", "position_placement");
  cfg->osd->position.offset_x = mlp_get_int ("aosd", "position_offset_x");
  cfg->osd->position.offset_y = mlp_get_int ("aosd", "position_offset_y");
  cfg->osd->position.maxsize_width = mlp_get_int ("aosd", "position_maxsize_width");
  cfg->osd->position.multimon_id = mlp_get_int ("aosd", "position_multimon_id");

  /* animation */
  cfg->osd->animation.timing_display = mlp_get_int ("aosd", "animation_timing_display");
  cfg->osd->animation.timing_fadein = mlp_get_int ("aosd", "animation_timing_fadein");
  cfg->osd->animation.timing_fadeout = mlp_get_int ("aosd", "animation_timing_fadeout");
  ...
  cfg->osd->text.utf8conv_disable = mlp_get_bool ("aosd", "text_utf8conv_disable");

  /* decoration */
  cfg->osd->decoration.code = mlp_get_int ("aosd", "decoration_code");

  /* TODO not implemented yet
  if ( !mlp_cfg_db_get_string( cfgfile , "aosd" ,
  ...
  */
  ...
  /* trigger */
  trig_active_str = mlp_get_string ("aosd", "trigger_active");
  ...
  /* miscellanous */
  cfg->osd->misc.transparency_mode = mlp_get_int ("aosd", "transparency_mode");
...
aosd_cfg_save ( aosd_cfg_t * cfg )
{
  ...
  /* position */
  mlp_set_int ("aosd", "position_placement", cfg->osd->position.placement);
  mlp_set_int ("aosd", "position_offset_x", cfg->osd->position.offset_x);
  mlp_set_int ("aosd", "position_offset_y", cfg->osd->position.offset_y);
  mlp_set_int ("aosd", "position_maxsize_width", cfg->osd->position.maxsize_width);
  mlp_set_int ("aosd", "position_multimon_id", cfg->osd->position.multimon_id);

  /* animation */
  mlp_set_int ("aosd", "animation_timing_display", cfg->osd->animation.timing_display);
  mlp_set_int ("aosd", "animation_timing_fadein", cfg->osd->animation.timing_fadein);
  mlp_set_int ("aosd", "animation_timing_fadeout", cfg->osd->animation.timing_fadeout);
  ...
  for ( i = 0 ; i < AOSD_TEXT_FONTS_NUM ; i++ )
  {
    ...
    key_str = g_strdup_printf( "text_fonts_name_%i" , i );
    mlp_set_string ("aosd", key_str, cfg->osd->text.fonts_name[i]);
    g_free( key_str );

    key_str = g_strdup_printf( "text_fonts_color_%i" , i );
    aosd_cfg_util_color_to_str( cfg->osd->text.fonts_color[i] , &color_str );
    mlp_set_string ("aosd", key_str, color_str);
    g_free( key_str );
    g_free( color_str );

    key_str = g_strdup_printf( "text_fonts_draw_shadow_%i" , i );
    mlp_set_bool ("aosd", key_str, cfg->osd->text.fonts_draw_shadow[i]);
    g_free( key_str );
  ...
  mlp_set_bool ("aosd", "text_utf8conv_disable", cfg->osd->text.utf8conv_disable);
  ...
  mlp_set_string ("aosd", "trigger_active", string->str);
  g_string_free( string , TRUE );

  /* miscellaneous */
  mlp_set_int ("aosd", "transparency_mode", cfg->osd->misc.transparency_mode);
