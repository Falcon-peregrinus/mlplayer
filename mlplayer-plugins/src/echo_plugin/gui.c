...
void echo_about (void)
{
	...
	mlpgui_simple_message (& echo_about_dialog, GTK_MESSAGE_INFO,
...
static void apply_changes(void)
{
	...
	mlp_set_int ("echo_plugin", "delay", echo_delay);
	mlp_set_int ("echo_plugin", "feedback", echo_feedback);
	mlp_set_int ("echo_plugin", "volume", echo_volume);
}
