...
static gboolean init (void)
{
	mlp_config_set_defaults ("echo_plugin", echo_defaults);

	echo_delay = mlp_get_int ("echo_plugin", "delay");
	echo_feedback = mlp_get_int ("echo_plugin", "feedback");
	echo_volume = mlp_get_int ("echo_plugin", "volume");
