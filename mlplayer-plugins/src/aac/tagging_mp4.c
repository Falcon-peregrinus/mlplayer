...
gchar *mlpmp4_get_artist (mp4ff_t * file)
{
    gchar *value;
...
gchar *mlpmp4_get_title (mp4ff_t * file)
{
    gchar *value;
...
gchar *mlpmp4_get_album (mp4ff_t * file)
{
    gchar *value;
...
gchar *mlpmp4_get_genre (mp4ff_t * file)
{
    gchar *value;
...
gint mlpmp4_get_year (mp4ff_t * file)
{
    gchar *value;
