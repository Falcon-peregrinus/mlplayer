...
#define feed_level mlp_get_int("bs2b", "feed")
#define fcut_level mlp_get_int("bs2b", "fcut")

gboolean init()
{
    mlp_config_set_defaults("bs2b", bs2b_defaults);
    bs2b = bs2b_open();
...
{
    mlp_set_int("bs2b", "feed", gtk_range_get_value(range));
    bs2b_set_level_feed(bs2b, feed_level);
}
...
{
    mlp_set_int("bs2b", "fcut", gtk_range_get_value(range));
    bs2b_set_level_fcut(bs2b, fcut_level);
}
